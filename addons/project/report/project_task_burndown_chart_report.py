...
class ReportProjectTaskBurndownChart(models.AbstractModel):
    ...
    def _read_group_raw(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        `school.py`. In order to be able to use the report on big databases, it is necessary to inject `WHERE`
        ...
        The code of `fill_temporal` has been removed from what's available in `school.py` as it is not relevant in the
        ...
        # --- Below code is from school.py read_group_raw
